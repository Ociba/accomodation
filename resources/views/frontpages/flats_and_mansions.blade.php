    ...
    <body>
        ...
        <section>
            <div class="container  margintop">
                <h2 class="section-header">Our Current Available Flats and Mansions
                    <br>
                    <small class="text-muted text-center">Wintermin makes your life easier. The best choice for your next project.</small>
                </h2>
                <div class="row">
                    @foreach($flats_and_mansions as $flats)
                    <div class="col-lg-3">
                        <!-- START widget-->
                        <div class="panel widget">
                            <img src="{{ asset('property_photos/'.$flats->photo)}}" style="width:318px; height:190px;" alt="Image" class="img-responsive">
                            ...
                            <div class="panel-body">
                                <div class="row row-table text-center">
                                    <div class="col-xs-6">
                                        <p>Bedrooms {{$flats->bedroom}}</p>
                                    </div>
                                    <div class="col-xs-6">
                                        <p>Status:{{$flats->property_status}}</p>
                                    </div>
                                </div>
                                <div class="row row-table text-center">
                                    <div class="col-xs-6">
                                        <span class="text-primar">Ugx.{{$flats->price}}</span>
                                    </div>
                                    <div class="col-xs-6">
                                        <span class="text-primar">{{$flats->location}}</span>
                                    </div>
                                </div>
                                <div class="row row-table text-center">
                                        <div class="col-xs-12">
                                        <a href="/chosen-property/{{$flats->id}}"><span class="btn btn-block btn-primary">Book Now</span></a>
                                        </div>
                                </div>
                            </div>
                        </div>
