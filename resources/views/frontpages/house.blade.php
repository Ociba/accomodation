    ...
    <body>
        ...
        <section class="bg-white">
            <div class="container  margintop">
                <h2 class="section-header">Our Current Available Houses
                    <br>
                    <small class="text-muted text-center">Wintermin makes your life easier. The best choice for your Affordable and Comfortable Accomodation.</small>
                </h2>
                <div class="row">
                    <div class="col-lg-3">
                        <!-- START widget-->
