    ...
    <body>
        ...
        <section class="bg-white">
            <div class="container  margintop">
                <h2 class="section-header">Our Current Available Stores
                    <br>
                    ...
                    <div class="col-lg-3">
                        ...
                        <img src="{{ asset('property_photos/'.$all->photo)}}" style="width:318px; height:190px;" alt="Image" class="img-responsive">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row row-table text-center">
                                    <div class="col-xs-6">
                                        <span class="text-primar">Ugx.{{$store->price}}</span>
                                    </div>
                                    <div class="col-xs-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills text-center">
                                    ...
                                    <li><a href="#flat-pills" data-toggle="tab">Flats and Mansions</li>
                                </ul>
                                <!-- Tab panes -->
