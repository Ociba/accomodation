            ...
            <div class="container">
                <nav class="row navbar navbar-default navbar-top navbar-fixed-top">
                    <div class="col-md-2 app-logo">
                        ...
                        <span style="margin-left:20px;"> <a href="/"><strong><i class="fa fa-phone" style="color:orange;"></i></a></span> | <span><a href="/"><i class="fa fa-facebook" style="color:orange;"></i></a> </span>| <span><a href="/"><i class="fa fa-twitter" style="color:orange;"></i></a></strong></span>
                ...
                <div class="row">
                    <div data-toggle="play-animation" data-play="fadeInRight" data-offset="-250" class="col-lg-12">
                        <div class="pane panel-default">
                            <div class="panel-heading text-center"><h4>More properties</h4></div>
                            <div class="panel-body">
                                <!-- Nav tabs -->
